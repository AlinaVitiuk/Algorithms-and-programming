...
void creat_mtr(int a[][size1], int n) 
{
	int b(100), c(10);
	for (int i = 0; i < n; i++)
		for (int j = 0; j < n; j++)
...
void print_mtr(int a[][size1], int n) 
{
	for (int i = 0; i < n; cout << endl, i++)
		for (int j = 0; j < n; cout.width(7), cout << a[i][j++]);
}
void sub_mtr(int c[][size1], int n, int q[][size1], int h[][size1])
{
	for (int i = 0; i < n; i++)
		for (int j = 0; j < n; j++)
			h[i][j] = c[i][j] - q[i][j];
}
void mult_mtr(int a[][size1], int n, int b[][size1], int c[][size1])
{
	for (int i = 0; i < n; i++)
		for (int j = 0; j < n; j++)
		{
...
void mult1_mtr(int a[][size1], int n, int b[][size1], int q[][size1])
{
	for (int i = 0; i < n; i++)
		for (int j = 0; j < n; j++)
		{
